...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Custom Vanilla Intersection Observer for Scroll Reveals
    ...
    <>
      ...
      <div className="page-section" id="hero">
        <div className="hero-video-bg">
          ...
          {/* Ensure you drop a video named hero-shoot.mp4 in your public folder */}
          <video autoPlay loop muted playsInline>
            <source src="/hero-shoot.mp4" type="video/mp4" />
          </video>
        </div>
        
        <div className="hero-content-wrapper">
          <div className="hero-glass-box glass-panel reveal-up">
            <h1 className="h1-brand">Madriph AI</h1>
            <h2 className="h2-tagline">
      ...
      {/* ── DYNAMIC MARQUEE ── */}
      <div className="mq-stack reveal-up d-1">
            ...
            <div className="about-g">
              ...
              <div className="about-txt reveal-up d-1">
                ...
                <p dangerouslySetInnerHTML={{ 
                  __html: content['about_paragraph'] || '<strong>Madriph AI</strong> is your premium creative powerhouse, stirring things up globally. We handle the heavy lifting across influencer marketing, social media, PR, performance marketing, and cutting-edge production, turning your boldest ideas into conversations people actually want to have.<br /><br />No fluff, no fake hype. Just razor-sharp strategy and flawless execution that feels <strong>100% real.</strong> We don\'t just build campaigns. We build presence.' 
                }} />
          ...
          <div className="sec-inner">
            ...
            <div className="svc-orbit-wrap reveal-up d-1">
              <div className="svc-universe">
                <div className="svc-center-star">Madriph<br />AI<br /><span>Services</span></div>
                ...
                <div className="svc-ring">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(0deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(0deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(51.4deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(-51.4deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(102.8deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(-102.8deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(154.2deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(-154.2deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(205.7deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(-205.7deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(257.1deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(-257.1deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
                  ...
                  <div className="svc-arm" style={{ transform: 'rotateZ(308.5deg) translateY(-450px)' }}>
                    <div className="svc-anti-spin"><div className="svc-anti-arm" style={{ transform: 'rotateZ(-308.5deg)' }}><div className="svc-stand-up"><div className="svc-c hover-target">
          ...
          <div className="sec-inner">
            ...
            <div className="cl-g reveal-up">
              {logos.length > 0 ? (
                ...
                <div style={{textAlign: 'center', width: '100%', color: 'var(--muted)'}}>No clients uploaded yet.</div>
              )}
            </div>
          </div>
        </section>
          ...
          <div className="sec-inner">
            ...
            <div className="ct-g">
              <div className="reveal-up d-1">
                <div className="ct-tagline" dangerouslySetInnerHTML={{ __html: content['contact_tagline'] || 'Let\'s Build Something<br /><em style="color: var(--p);">Great Together.</em>' }} />
                <div className="ct-items">
                  <div className="ct-item hover-target">
                    <div className="ct-item-ic">📧</div>
                    <div className="ct-item-tx"><a href={`mailto:${content['contact_email'] || 'hello@madriphai.com'}`} style={{color: 'inherit', textDecoration: 'none'}}>{content['contact_email'] || 'hello@madriphai.com'}</a></div>
                  </div>
                  <div className="ct-item hover-target">
                    <div className="ct-item-ic">📞</div>
                    <div className="ct-item-tx"><a href={`tel:${content['contact_phone'] || '+911234567890'}`} style={{color: 'inherit', textDecoration: 'none'}}>{content['contact_phone'] || '+91 12345 67890'}</a></div>
                  </div>
        ...
        <footer>
          <div className="ft-g">
            <div className="reveal-up">
              <a href="#hero" className="ft-logo hover-target">
                Madriph AI
              </a>
              <p className="ft-tag">{content['footer_tagline'] || 'Premium creative media agency. The real fame story starts here.'}</p>
            </div>
            <div className="reveal-up d-1">
            ...
            <div className="reveal-up d-3">
              ...
              <ul className="ft-lks">
                <li><a href={`mailto:${content['contact_email'] || 'hello@madriphai.com'}`} className="hover-target">{content['contact_email'] || 'hello@madriphai.com'}</a></li>
                <li><a href={`tel:${content['contact_phone'] || '+911234567890'}`} className="hover-target">{content['contact_phone'] || '+91 12345 67890'}</a></li>
                <li><a href="#" className="hover-target" style={{pointerEvents: 'none'}}>{content['contact_location'] || 'New Delhi, India'}</a></li>
              </ul>
            </div>
          </div>
          <div className="ft-bot reveal-up">
            <span>{content['footer_copyright'] || '© 2026 Madriph AI. All rights reserved.'}</span>
