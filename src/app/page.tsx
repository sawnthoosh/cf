    ...
    <>
      ...
      <footer style={{ borderTop: 'none', padding: '80px 5% 40px', background: 'var(--w)' }}>
        ...
        <div className="ft-bot" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px', paddingTop: '30px', borderTop: '1px solid var(--gm)' }}>
          ...
          <div style={{ color: 'var(--muted)', fontSize: '0.9rem', display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
            <span>© 2026 Claim Fame. All rights reserved.</span>
            <span style={{ opacity: 0.5 }}>|</span>
            <span style={{ fontWeight: 600 }}>Made with <span style={{ color: 'var(--p)' }}>OnlyUs Media</span></span>
          </div>
