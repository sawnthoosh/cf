...
export default function ServicesSection() {
  ...
  return (
    <div className="page-section" id="services" style={{ padding: '80px 2%', maxWidth: '1400px', margin: '0 auto', textAlign: 'center', background: 'var(--w)' }}>
      ...
      <div className="services-grid reveal-up d-2" style={{ padding: '0 2%' }}>
            ...
            >
              ...
              {isActive && (
                <div style={{ color: '#fff', padding: '40px 30px', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  ...
                  <ul style={{ listStyle: 'none', fontSize: '1.05rem', display: 'flex', flexDirection: 'column', gap: '12px', paddingLeft: 0 }}>
